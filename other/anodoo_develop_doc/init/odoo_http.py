...
# l Request
# 	n 重要信息
# 		u Session，url，cookie，stream，env，form，header
# 		u app  Root类
# 	n WebRequest
# 		u JsonRequest
# 		u HttpRequest
# l Controller / ControllerType  L894 定了一个别名
# 	n 所以的controller都是继承这里
# l EndPoint
# 	n _generate_routing_rules  扫描所有module中的routing装饰器，找到url和对应method的关系
# 	n EndPoint就是这个method的包装
# l Root
# 	n 核心类
# 	n Dispatch方法
# 		u 获得request
# 		u 调用ir_http的dispatch函数
# 		u 得到result，包装为response
# l OpenERPSession
# 	n Session id
# 		u 在request header中找
# 		u 在cookie中找
# 	n Session Store
# 		u 文件系统中找所有的session信息
# 		u 根据session id
# l Response
# l Controller
# https://alanhou.org/odoo-13-web-controllers/
#  
# https://yq.aliyun.com/articles/623183
# https://www.cnblogs.com/qjtjh/p/8269699.html
#  
#  
# l 定义Class my(controller):
# l 继承
# l 重写方法
# l Route
# 	n Route
# 		u 参见 werkzeug的路由文档了解路由表达式的格式( http://werkzeug.pocoo.org/docs/routing/ )。
# 		u Type : http, json
