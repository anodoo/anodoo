...
sql_db是介于orm和postgresql之间的，对psycopg2的使用
连接Connection，PsycoConnection，连接池ConnectionPool，
游标Cursor

l PostgreSQL的connector，是ORM的底层
l Psycopg 
	n http://initd.org/psycopg/
	n Psycopg is the most popular PostgreSQL adapter for the Python programming language. At its core it fully implements the Python DB API 2.0 specifications. Several extensions allow access to many of the features offered by PostgreSQL.
l Cursor
l  
l Connection和PsycoConnection
l  
l Pool   ConnectionPool
L688 定义了一个pool， L693设置为ConnectionPool
